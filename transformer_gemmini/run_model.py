...
MAPPING_PATH = f"{os.curdir}/mapper/mapping.yaml"
...
output_dir = f"{os.curdir}/outputs_model_{sys.argv[1]}" + (("_" + sys.argv[2]) if level_for_fusion else "")
if not os.path.exists(output_dir): os.makedirs(output_dir)
tl.call_model(spec, output_dir=output_dir)  # Run the Timeloop mapper
